...
<template>
  ...
  <div class="flex flex-wrap gap-3 pt-2">
            ...
            <button class="bg-primary hover:bg-primary/90 px-5 py-2.5 rounded-lg font-medium flex items-center transition-all" @click="emit('play')" :disabled="isPlaying">
    ...
    <button class="bg-primary hover:bg-primary/90 px-5 py-2.5 rounded-lg font-medium flex items-center transition-all"
    ...
    <button class="bg-gray-700 hover:bg-gray-600 px-5 py-2.5 rounded-lg font-medium flex items-center transition-all"
    ...
    <span v-if="isRecording" class="bg-gray-700 hover:bg-gray-600 px-5 py-2.5 rounded-lg font-medium flex items-center transition-all">
      ● Gravando
    </span>
